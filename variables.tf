...
variable "falcon_client_id" {
  ...
  validation {
    ...
    error_message = "falcon_client_id is required when enable_realtime_visibility is set to true. Please use the Falcon console to generate a new API key/secret pair with appropriate scopes."
  }
}
...
variable "falcon_client_secret" {
  ...
  validation {
    ...
    error_message = "falcon_client_secret is required when enable_realtime_visibility is set to true. Please use the Falcon console to generate a new API key/secret pair with appropriate scopes."
  }
}
