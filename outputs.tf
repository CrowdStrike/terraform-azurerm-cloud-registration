...
output "active_subscriptions_in_groups" {
  ...
  value       = var.log_ingestion_settings.enabled ? module.deployment_scope.active_subscriptions_by_group : null
}

output "activity_log_eventhub_id" {
  description = "Resource ID of the Event Hub used for Azure Activity Log ingestion"
  value       = var.log_ingestion_settings.enabled && var.log_ingestion_settings.activity_log.enabled ? module.log_ingestion[0].activity_log_eventhub_id : null
}
...
output "activity_log_eventhub_consumer_group_name" {
  ...
  value       = var.log_ingestion_settings.enabled && var.log_ingestion_settings.activity_log.enabled ? module.log_ingestion[0].activity_log_eventhub_consumer_group_name : null
}
...
output "entra_id_log_eventhub_id" {
  ...
  value       = var.log_ingestion_settings.enabled && var.log_ingestion_settings.entra_id_log.enabled ? module.log_ingestion[0].entra_id_log_eventhub_id : null
}
...
output "entra_id_log_eventhub_consumer_group_name" {
  ...
  value       = var.log_ingestion_settings.enabled && var.log_ingestion_settings.entra_id_log.enabled ? module.log_ingestion[0].entra_id_log_eventhub_consumer_group_name : null
}
