output "role_definition_ids" {
  ...
  value = {
    ...
    rg_access_target     = var.scope_type == "mg" ? (var.is_host ? azurerm_role_definition.rg_access_target[0].role_definition_resource_id : azurerm_role_definition.rg_access.role_definition_resource_id) : ""
