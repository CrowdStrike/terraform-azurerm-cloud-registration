...
output "service_principal_object_id" {
  description = "Object ID of the CrowdStrike service principal used for Azure resource access (provided by Identity Team)"
  value       = var.crowdstrike_service_principal_object_id
}
