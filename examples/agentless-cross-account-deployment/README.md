# FCS Agentless Registration With Cross-Account

This example demonstrates how to register subscriptions with CrowdStrike Falcon Cloud
Security (FCS) and DSPM enabled with cross-account setup.
